...
public class Tabuleiro implements Serializable {
        ...
        /**
         * Dada uma peça, retorna uma lista de possíveis movimentos e/ou capturas que ela pode
         * realizar.
         *
        ...
        /**
         * Retorna uma lista de posições possíveis que uma torre pode se movimentar ou capturar.
         *
        ...
        /**
         * Retorna uma lista de posições possíveis que um bispo pode se movimentar ou capturar.
         *
        ...
        /**
         * Retorna uma lista de posições possíveis que uma rainha pode se movimentar ou capturar.
         *
        ...
        /**
         * Retorna uma lista de posições possíveis que um rei pode se movimentar ou capturar.
         *
        ...
        /**
         * Retorna uma lista de posições possíveis que um cavalo pode se movimentar ou capturar.
         *
        ...
        /**
         * Retorna uma lista com todas as posições de movimento e captura que um peão consegue
         * realizar.
         *
        ...
        /**
         * Retorna a lista de posições possiveis que um peão consegue capturar alguma peça.
         *
        ...
        /**
         * Retorna uma lista com todas as posições possíveis que um peão consegue se movimentar.
         *
         * @param posicao - a posição do peão do qual deseja-se saber as posições possíveis.
        ...
        /**
         * Esse método verifica se o caminho realizado por um peão em sua primeira jogada, quando
         * este se move duas casas, é valido, ou seja, informa se o peão tem o caminho obstruído.
         * Esse método só é chamado na situação em que o peão anda duas casas.
         *
         * @param posicaoInicial - posição inicial do peão.
         * @param posicaoFinal - posição para onde se quer verificar se o peão consegue fazer o
         * movimento.
